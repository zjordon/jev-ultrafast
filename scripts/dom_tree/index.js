/**
 * Port of browser-use dom_tree (0.5.9, d51b6e73) with the local @edit improvements,
 * copied from ai-agent/page-agent page-controller to compare its output with
 * jev_ultrafast/snapshot.js. See docs/agent-core/DOM采集方案对比-dom_tree与snapshot.md.
 *
 * The only port change: the ES-module `export default (` wrapper became
 * `const __domTree = (` so this file is a plain script that Runtime.evaluate can run.
 * The function body below is intentionally unchanged; all options (including
 * doHighlightElements) are passed by the caller.
 */
